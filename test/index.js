/* eslint-disable max-lines, n/no-sync */
...
/**
 * @import {SassModule, SassRenderError} from '../lib/types.ts'
				...
				const expected = resolveExpectedResults([
					{
						...
						stack: [
							'at root stylesheet (test/fixtures/errors.stylesheet-import.scss:27:4)'
						],
						type: 'deprecation'
					},
					{
			...
			it('should handle errors for function declarations and invocations', async function () {
				...
				const [actualAsync, actualSync] = await Promise.all([
					renderer.compileAsync(
						'./test/fixtures/errors.function-declaration-invocation.scss'
					),
		...
		describe('Undefined functions', function () {
				...
				const expected = resolveExpectedResults([
					{
						...
						stack: [
							'at root stylesheet (test/fixtures/errors.undefined-functions.scss:12:9)'
						],
						source: {
							end: {
								column: 14,
					...
					},
					{
						...
						message: 'Undefined function.',
						stack: [
							'at root stylesheet (test/fixtures/errors.undefined-functions.scss:14:16)'
						],
						source: {
							end: {
								column: 22,
					...
					},
					{
						...
						message: 'Undefined function.',
						stack: [
							'at root stylesheet (test/fixtures/errors.undefined-functions.scss:17:11)'
						],
						source: {
							end: {
								column: 17,
					...
					},
					{
						...
						message: 'Undefined function.',
						stack: [
							'at root stylesheet (test/fixtures/errors.undefined-functions.scss:19:10)'
						],
						source: {
							end: {
								column: 14,
					...
					},
					{
						...
						message: 'Undefined function.',
						stack: [
							'at root stylesheet (test/fixtures/errors.undefined-functions.scss:21:19)'
						],
						source: {
							end: {
								column: 23,
			...
			it('should handle errors, disallowed known and additional unknown CSS functions', async function () {
				...
				const [actualAsync, actualSync] = await Promise.all([
					...
					renderer.compile(
						'./test/fixtures/errors.undefined-functions.disallowed-functions.scss'
					)
				]);
				const expected = resolveExpectedResults([
					{
		...
		describe('All implementations', function () {
			it('should handle errors', async function () {
				...
				const actualAsync = await Promise.all([
					rendererUndefinedFunctions.compileAsync(
						'./test/fixtures/deprecations.all.scss'
					),
